...
if page == "🏠 Home":
    ...
    with col1:
       st.image("https://raw.githubusercontent.com/Aditya1265/satellite-ai-app/main/assets/Birla_Institute_of_Technology_Mesra.png", width=200)
       st.markdown("### BIT Mesra")
       st.markdown("#### AI-Powered Satellite Communication System")
    
    with col2:
        st.image("https://raw.githubusercontent.com/Aditya1265/satellite-ai-app/main/assets/917923.png", use_container_width=True)
...
# 🚀 Data Visualization Page
    ...
    if "prediction" in st.session_state and st.session_state.prediction is not None:
        ...
        sns.barplot(x=["Frequency", "Bandwidth", "Noise", "Latency", "Packet Loss"],
            y=[
                st.session_state.get("frequency", 0),
